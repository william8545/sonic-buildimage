...
"""
SONiC Platform API - Fan class for NVIDIA AST2700 BMC

This module provides the Fan class for NVIDIA AST2700 BMC platform.
...
class Fan(FanBase):
    """
    Fan class for NVIDIA AST2700 BMC platform
    ...
    # TODO: Update HWMON paths for NVIDIA hardware
    ...
    def get_speed(self):
        ...
        Returns:
            An integer, the percentage of full fan speed, in the range 0 to 100
        """
    ...
    def set_speed(self, speed):
        ...
        Args:
            speed: An integer, the percentage of full fan speed to set (0-100)
